...
KNOWN_SECRETS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "hint": "Neural web search with semantic ranking.",
        "in_process": True,
    },
    {
        ...
        "hint": "Parallel web search backend.",
        "in_process": True,
    },
    {
        "key": "SEARXNG_URL",
        ...
        "hint": "URL of your self-hosted SearXNG instance (e.g. http://searxng.railway.internal:8080).",
        "in_process": True,
    },
    {
        "key": "XAI_API_KEY",
        ...
        "hint": "xAI image generation (also enables Grok text models).",
        "in_process": True,
    },
    {
    ...
    },
    {
        ...
        "hint": "Whisper STT plus fast LLM inference.",
        "in_process": True,
    },
    {
        "key": "MISTRAL_API_KEY",
        ...
        "hint": "Voxtral STT plus Mistral LLMs.",
        "in_process": True,
    },
    {
        "key": "MEM0_API_KEY",
        ...
        "hint": "Hosted long-term memory provider.",
        "in_process": True,
    },
    {
        "key": "HONCHO_API_KEY",
        ...
        "hint": "Cross-session user modeling.",
        "in_process": True,
    },
    {
        ...
        "hint": "Supermemory long-term memory backend.",
        "in_process": True,
    },
    {
        ...
        "hint": "Langfuse tracing — pair with LANGFUSE_SECRET_KEY and LANGFUSE_HOST.",
        "in_process": True,
    },
    {
        ...
        "group": "observability",
        "url": "https://cloud.langfuse.com/",
        "hint": "Langfuse tracing — pair with LANGFUSE_PUBLIC_KEY.",
        "in_process": True,
    },
    {
        "key": "LANGFUSE_HOST",
        ...
        "hint": "Langfuse base URL (e.g. https://cloud.langfuse.com or self-hosted).",
        "in_process": True,
    },
)
